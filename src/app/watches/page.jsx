...
//   let products = await Product.find({ category: "watches" }).lean();
...
//           <h1 className="text-3xl font-bold mb-10 text-center">watches</h1>
...
export default async function WatchesPage() {
  ...
  const products = await Product.find({ category: "watches" }).lean();
